...
$arOptions = [
    ...
    [
        ...
        'TYPE' => 'M_SELECT', //- тип свойства multi select
    ...
    [
        ...
        'SORT' => '1',
        'NAME' => 'text_key',
        'TITLE' => 'Текст ключ-значение',
        'TYPE' => 'KEY_VALUE', //- тип свойства key_value
    ],
    [
        'GROUP' => 'KEYVALUE',
        'SORT' => '2',
        'NAME' => 'multi_text_key',
        'TITLE' => 'Мультитекст ключ-значение',
        'TYPE' => 'M_KEY_VALUE', //- тип свойства m_key_value
    ],
];

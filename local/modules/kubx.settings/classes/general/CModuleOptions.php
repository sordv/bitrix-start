    ...
    <td>
        <div id="'.$name.'" style="display: flex; flex-direction: column">
            ...
            <div class="img_delete_box" style="margin-top: 5px; background-color: #e0e8ea; padding: 5px; ' . $display . ' flex-direction: column; align-items: center">
                ...
                <input type="button" value="Удалить логотип" style="width: 50%; margin-top: 10px;" class="delete">
            </div>
        </div>
    </td>
    <script>
        ...
        if(delete_'.$name.'){
            delete_'.$name.'.addEventListener("click", () => {
                ...
                input_'.$name.'.value = "";
                    ...
                    break;
                case 'KEY_VALUE':
                    $valueRes = strlen($value) ? explode('::', $value) : [];
                    echo '
<tr>
    <td class="adm-detail-valign-top adm-detail-content-cell-l" width="50%" style="vertical-align: middle;">
        '.$title.':
    ...
    <div id="'.$name.'" style="display: flex; flex-direction: column">
        <div class="keyvalue-result">
            <input type="text" class="key" value="'.$valueRes[0].'" placeholder="Ключ" style="width: 30%">
            <input type="text" class="value" value="'.$valueRes[1].'" placeholder="Значение" style="width: 50%"> 
        </div>
        <input type="text" style="display: none" name="'.$name.'" value="'.$value.'">
    </div> 
    </td>
                    ...
                    if (!empty($res)) {
                        foreach ($res as &$val) {
                            ...
                            <div class="keyvalue-box" style="margin-bottom: 5px">
                                <input type="text" class="key" value="'.$val[0].'" placeholder="Ключ" style="width: 30%">
                                <input type="text" class="value" value="'.$val[1].'" placeholder="Значение" style="width: 50%"> 
